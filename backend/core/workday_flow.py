...
async def _run_llm_cleanup(
    ...
    *,
    ...
    task = (
        ...
        "4c. Open-ended written questions (essays, 'tell us about', 'describe a time', 'why this company', "
        "'what is the hardest problem you have solved', cover letter boxes, 'anything else you want to share') are yours "
        "to answer. Write the answer yourself from the candidate facts below, the job title and the company name. "
        "Two to five sentences, specific, first person, plain language, no invented employers, degrees, dates or metrics. "
